...
console.log(solarSystem[2]);
 ...
 //  console.log(system[0].mass); // wrong not array
...
//   let sum=  parseInt(system.jupiter.satellites+system.saturn.satellites+system.uranus.satellites+system.neptune.satellites);
//   console.log(sum);
let sum = parseInt(system.jupiter.satellites) + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites;
console.log(sum);
